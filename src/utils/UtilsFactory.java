...
public class UtilsFactory extends EFactoryImpl {
	 ...
	 * @generated
	 */
	public static final UtilsFactory INSTANCE = utils.UtilsFactory.eINSTANCE;
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case UtilsPackage.FAS_STATUS:
				return createFASStatusFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case UtilsPackage.FAS_STATUS:
				return convertFASStatusToString(eDataType, instanceValue);
			case UtilsPackage.RECOMMENDATION_TYPES:
	 ...
	 * @generated
	 */
	public FASStatus createFASStatusFromString(EDataType eDataType, String initialValue) {
		FASStatus result = FASStatus.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertFASStatusToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
