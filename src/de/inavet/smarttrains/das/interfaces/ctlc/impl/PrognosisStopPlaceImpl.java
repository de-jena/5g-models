...
public class PrognosisStopPlaceImpl extends MinimalEObjectImpl.Container implements PrognosisStopPlace {
	...
	public MarkedPosition getStopPosition() {
		if (stopPosition != null && stopPosition.eIsProxy()) {
			InternalEObject oldStopPosition = (InternalEObject)stopPosition;
			stopPosition = (MarkedPosition)eResolveProxy(oldStopPosition);
			if (stopPosition != oldStopPosition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CtlcPackage.PROGNOSIS_STOP_PLACE__STOP_POSITION, oldStopPosition, stopPosition));
			}
		}
		return stopPosition;
	}
	...
	public void setStopPosition(MarkedPosition newStopPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CtlcPackage.PROGNOSIS_STOP_PLACE__STOP_POSITION, oldStopPosition, stopPosition));
	}
