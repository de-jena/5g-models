...
public class CtlcPackageImpl extends EPackageImpl implements CtlcPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getUpdateForVehicle_Vehicle(), theUtilsPackage.getVehicle(), null, "vehicle", null, 1, 1, UpdateForVehicle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMarkedPosition_Id(), ecorePackage.getEString(), "id", null, 1, 1, MarkedPosition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMarkedPosition_Name(), ecorePackage.getEString(), "name", null, 1, 1, MarkedPosition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPrognosisOverride_Vehicle(), theUtilsPackage.getVehicle(), null, "vehicle", null, 1, 1, PrognosisOverride.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrognosisOverride_Prognosis(), this.getPrognosisArrivalAndPosition(), null, "prognosis", null, 1, 1, PrognosisOverride.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
