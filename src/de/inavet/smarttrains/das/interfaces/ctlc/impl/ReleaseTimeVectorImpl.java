...
public class ReleaseTimeVectorImpl extends MinimalEObjectImpl.Container implements ReleaseTimeVector {
		...
		if (signalGroup != null && signalGroup.eIsProxy()) {
			...
			if (signalGroup != oldSignalGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CtlcPackage.RELEASE_TIME_VECTOR__SIGNAL_GROUP, oldSignalGroup, signalGroup));
			}
		}
		return signalGroup;
	}
	...
	public void setSignalGroup(SignalGroup newSignalGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CtlcPackage.RELEASE_TIME_VECTOR__SIGNAL_GROUP, oldSignalGroup, signalGroup));
	}
