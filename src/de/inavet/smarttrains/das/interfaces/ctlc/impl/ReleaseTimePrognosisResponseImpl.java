...
public class ReleaseTimePrognosisResponseImpl extends MinimalEObjectImpl.Container implements ReleaseTimePrognosisResponse {
	...
	/**
	 * The cached value of the '{@link #getReleaseTimes() <em>Release Times</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getReleaseTimes()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getReleaseTimesForScenarios() <em>Release Times For Scenarios</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<ReleaseTimeVector> getReleaseTimes() {
		if (releaseTimes == null) {
			releaseTimes = new EObjectContainmentEList<ReleaseTimeVector>(ReleaseTimeVector.class, this, CtlcPackage.RELEASE_TIME_PROGNOSIS_RESPONSE__RELEASE_TIMES);
		}
		return releaseTimes;
	}
	...
	public EList<ScenarioPrognosis> getReleaseTimesForScenarios() {
		if (releaseTimesForScenarios == null) {
			releaseTimesForScenarios = new EObjectContainmentEList<ScenarioPrognosis>(ScenarioPrognosis.class, this, CtlcPackage.RELEASE_TIME_PROGNOSIS_RESPONSE__RELEASE_TIMES_FOR_SCENARIOS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CtlcPackage.RELEASE_TIME_PROGNOSIS_RESPONSE__RELEASE_TIMES:
				return ((InternalEList<?>)getReleaseTimes()).basicRemove(otherEnd, msgs);
			case CtlcPackage.RELEASE_TIME_PROGNOSIS_RESPONSE__RELEASE_TIMES_FOR_SCENARIOS:
				return ((InternalEList<?>)getReleaseTimesForScenarios()).basicRemove(otherEnd, msgs);
		}
