...
public interface PrognosisStopPlace extends EObject {
	/**
	 * Returns the value of the '<em><b>Stop Position</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Stop Position</em>' containment reference.
	...
	/**
	 * Sets the value of the '{@link de.inavet.smarttrains.das.interfaces.ctlc.PrognosisStopPlace#getStopPosition <em>Stop Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Stop Position</em>' containment reference.
	 * @see #getStopPosition()
	 * @generated
	 */
