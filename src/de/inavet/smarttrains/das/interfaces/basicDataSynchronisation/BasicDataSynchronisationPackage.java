...
public interface BasicDataSynchronisationPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://inavet.de/datamodels";
	...
	/**
	 * The feature id for the '<em><b>Vehicle Ids</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '{@link de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.impl.VehicleIdImpl <em>Vehicle Id</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.impl.VehicleIdImpl
	 * @see de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.impl.BasicDataSynchronisationPackageImpl#getVehicleId()
	 * @generated
	 */
	int VEHICLE_ID = 5;
	 ...
	 * @ordered
	 */
	int VEHICLE_ID__VEHICLE_ID = 0;

	/**
	 * The number of structural features of the '<em>Vehicle Id</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int VEHICLE_ID_FEATURE_COUNT = 1;

	/**
	 * The number of operations of the '<em>Vehicle Id</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int VEHICLE_ID_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the reference '{@link de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.BasicData#getVehicleIds <em>Vehicle Ids</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Vehicle Ids</em>'.
	 * @see de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.BasicData#getVehicleIds()
	 * @see #getBasicData()
	 * @generated
	 */
	EReference getBasicData_VehicleIds();
	...
	/**
	 * Returns the meta object for class '{@link de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.VehicleId <em>Vehicle Id</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Vehicle Id</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.VehicleId#getVehicleId <em>Vehicle Id</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Vehicle Id</em>'.
	 * @see de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.VehicleId#getVehicleId()
	 * @see #getVehicleId()
	 * @generated
	 */
	EAttribute getVehicleId_VehicleId();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Vehicle Ids</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference BASIC_DATA__VEHICLE_IDS = eINSTANCE.getBasicData_VehicleIds();
		...
		/**
		 * The meta object literal for the '{@link de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.impl.VehicleIdImpl <em>Vehicle Id</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.impl.VehicleIdImpl
		 * @see de.inavet.smarttrains.das.interfaces.basicDataSynchronisation.impl.BasicDataSynchronisationPackageImpl#getVehicleId()
		 * @generated
		 */
		EClass VEHICLE_ID = eINSTANCE.getVehicleId();
		 ...
		 * @generated
		 */
		EAttribute VEHICLE_ID__VEHICLE_ID = eINSTANCE.getVehicleId_VehicleId();
