...
public interface PrognosisPositionAndElectricalLoad extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Prognosis Position</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Prognosis Position</em>' containment reference.
	...
	/**
	 * Sets the value of the '{@link de.inavet.smarttrains.das.interfaces.lm.PrognosisPositionAndElectricalLoad#getPrognosisPosition <em>Prognosis Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Prognosis Position</em>' containment reference.
	...
	/**
	 * Returns the value of the '<em><b>Electrical Load Prognosis</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Electrical Load Prognosis</em>' containment reference.
	...
	/**
	 * Sets the value of the '{@link de.inavet.smarttrains.das.interfaces.lm.PrognosisPositionAndElectricalLoad#getElectricalLoadPrognosis <em>Electrical Load Prognosis</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Electrical Load Prognosis</em>' containment reference.
