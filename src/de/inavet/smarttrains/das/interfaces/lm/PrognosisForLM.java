...
public interface PrognosisForLM extends EObject {
	/**
	 * Returns the value of the '<em><b>Present Position</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Present Position</em>' containment reference.
	...
	/**
	 * Sets the value of the '{@link de.inavet.smarttrains.das.interfaces.lm.PrognosisForLM#getPresentPosition <em>Present Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Present Position</em>' containment reference.
	...
	/**
	 * Returns the value of the '<em><b>Present Electrical Load</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Present Electrical Load</em>' containment reference.
	...
	/**
	 * Sets the value of the '{@link de.inavet.smarttrains.das.interfaces.lm.PrognosisForLM#getPresentElectricalLoad <em>Present Electrical Load</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Present Electrical Load</em>' containment reference.
	...
	/**
	 * Returns the value of the '<em><b>Prognosis For Position And Electrical Load</b></em>' containment reference list.
	 * The list contents are of type {@link de.inavet.smarttrains.das.interfaces.lm.PrognosisPositionAndElectricalLoad}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Prognosis For Position And Electrical Load</em>' containment reference list.
