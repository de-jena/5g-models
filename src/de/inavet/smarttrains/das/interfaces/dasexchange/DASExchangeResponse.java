...
public interface DASExchangeResponse extends EObject {
	 ...
	 * @see de.inavet.smarttrains.das.interfaces.dasexchange.DasexchangePackage#getDASExchangeResponse_FasExchangeIdToResponse()
	 * @model
	 * @generated
	 */
	String getFasExchangeIdToResponse();
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Fas Exchange Id To Response</em>' attribute.
	 * @see #getFasExchangeIdToResponse()
	 * @generated
	 */
	void setFasExchangeIdToResponse(String value);
