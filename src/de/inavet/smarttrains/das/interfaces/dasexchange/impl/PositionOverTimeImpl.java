...
public class PositionOverTimeImpl extends MinimalEObjectImpl.Container implements PositionOverTime {
	...
	public NotificationChain basicSetPosition(Position newPosition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DasexchangePackage.POSITION_OVER_TIME__POSITION, oldPosition, newPosition);
	...
	public void setPosition(Position newPosition) {
		if (newPosition != position) {
			...
			if (position != null)
				msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DasexchangePackage.POSITION_OVER_TIME__POSITION, null, msgs);
			if (newPosition != null)
				msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DasexchangePackage.POSITION_OVER_TIME__POSITION, null, msgs);
			msgs = basicSetPosition(newPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DasexchangePackage.POSITION_OVER_TIME__POSITION, newPosition, newPosition));
	}
