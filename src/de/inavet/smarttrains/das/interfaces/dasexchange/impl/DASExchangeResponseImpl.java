 ...
 *   <li>{@link de.inavet.smarttrains.das.interfaces.dasexchange.impl.DASExchangeResponseImpl#getFasExchangeIdToResponse <em>Fas Exchange Id To Response</em>}</li>
...
public class DASExchangeResponseImpl extends MinimalEObjectImpl.Container implements DASExchangeResponse {
	...
	public void setFasExchangeIdToResponse(String newFasExchangeIdToResponse) {
		String oldFasExchangeIdToResponse = fasExchangeIdToResponse;
		fasExchangeIdToResponse = newFasExchangeIdToResponse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DasexchangePackage.DAS_EXCHANGE_RESPONSE__FAS_EXCHANGE_ID_TO_RESPONSE, oldFasExchangeIdToResponse, fasExchangeIdToResponse));
	}
