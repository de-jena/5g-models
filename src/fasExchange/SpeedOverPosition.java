 ...
 * </p>
 * <ul>
 *   <li>{@link fasExchange.SpeedOverPosition#getSpeed <em>Speed</em>}</li>
 *   <li>{@link fasExchange.SpeedOverPosition#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpeedOverPosition extends MinimalEObjectImpl.Container {
	...
	protected EClass eStaticClass() {
		return FasExchangePackage.Literals.SPEED_OVER_POSITION;
	}
	...
	/**
	 * Sets the value of the '{@link fasExchange.SpeedOverPosition#getSpeed <em>Speed</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link fasExchange.SpeedOverPosition#getPosition <em>Position</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FasExchangePackage.SPEED_OVER_POSITION__SPEED:
				if (resolve) return getSpeed();
				return basicGetSpeed();
			case FasExchangePackage.SPEED_OVER_POSITION__POSITION:
