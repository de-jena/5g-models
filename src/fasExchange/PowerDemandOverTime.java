 ...
 * </p>
 * <ul>
 *   <li>{@link fasExchange.PowerDemandOverTime#getPowerPrognosis <em>Power Prognosis</em>}</li>
 *   <li>{@link fasExchange.PowerDemandOverTime#getTimestamp <em>Timestamp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PowerDemandOverTime extends MinimalEObjectImpl.Container {
	...
	protected EClass eStaticClass() {
		return FasExchangePackage.Literals.POWER_DEMAND_OVER_TIME;
	}
	 ...
	 * @generated
	 */
	public List<ZonedDateTime> getTimestamp() {
		if (timestamp == null) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FasExchangePackage.POWER_DEMAND_OVER_TIME__POWER_PROGNOSIS:
				return getPowerPrognosis();
			case FasExchangePackage.POWER_DEMAND_OVER_TIME__TIMESTAMP:
				return getTimestamp();
		}
