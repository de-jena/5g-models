 ...
 * </p>
 * <ul>
 *   <li>{@link fasExchange.TimeSlotOnJourney#getTimeSlot <em>Time Slot</em>}</li>
 *   <li>{@link fasExchange.TimeSlotOnJourney#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeSlotOnJourney extends MinimalEObjectImpl.Container {
	...
	protected EClass eStaticClass() {
		return FasExchangePackage.Literals.TIME_SLOT_ON_JOURNEY;
	}
	...
	/**
	 * Sets the value of the '{@link fasExchange.TimeSlotOnJourney#getTimeSlot <em>Time Slot</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link fasExchange.TimeSlotOnJourney#getPosition <em>Position</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FasExchangePackage.TIME_SLOT_ON_JOURNEY__TIME_SLOT:
				if (resolve) return getTimeSlot();
				return basicGetTimeSlot();
			case FasExchangePackage.TIME_SLOT_ON_JOURNEY__POSITION:
