 ...
 * </p>
 * <ul>
 *   <li>{@link fasExchange.PrognosisTimeSlotFromkLSA#getId <em>Id</em>}</li>
 *   <li>{@link fasExchange.PrognosisTimeSlotFromkLSA#getKeyCosts <em>Key Costs</em>}</li>
 *   <li>{@link fasExchange.PrognosisTimeSlotFromkLSA#getTimeSlots <em>Time Slots</em>}</li>
 *   <li>{@link fasExchange.PrognosisTimeSlotFromkLSA#getVehicles <em>Vehicles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrognosisTimeSlotFromkLSA extends MinimalEObjectImpl.Container {
	 ...
	 * @generated
	 */
	public PrognosisTimeSlotFromkLSA() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FasExchangePackage.Literals.PROGNOSIS_TIME_SLOT_FROMK_LSA;
	}
	...
	/**
	 * Sets the value of the '{@link fasExchange.PrognosisTimeSlotFromkLSA#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public List<ValueItem> getKeyCosts() {
		if (keyCosts == null) {
	 ...
	 * The list contents are of type {@link fasExchange.TimeSlot}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Zeitfensterangaben
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FasExchangePackage.PROGNOSIS_TIME_SLOT_FROMK_LSA__ID:
				return getId();
			case FasExchangePackage.PROGNOSIS_TIME_SLOT_FROMK_LSA__KEY_COSTS:
				return getKeyCosts();
			case FasExchangePackage.PROGNOSIS_TIME_SLOT_FROMK_LSA__TIME_SLOTS:
				return getTimeSlots();
			case FasExchangePackage.PROGNOSIS_TIME_SLOT_FROMK_LSA__VEHICLES:
				return getVehicles();
		}
