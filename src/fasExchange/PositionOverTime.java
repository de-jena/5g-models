 ...
 * </p>
 * <ul>
 *   <li>{@link fasExchange.PositionOverTime#getPosition <em>Position</em>}</li>
 *   <li>{@link fasExchange.PositionOverTime#getTimestamp <em>Timestamp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PositionOverTime extends MinimalEObjectImpl.Container {
	...
	protected EClass eStaticClass() {
		return FasExchangePackage.Literals.POSITION_OVER_TIME;
	}
	...
	/**
	 * Sets the value of the '{@link fasExchange.PositionOverTime#getPosition <em>Position</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link fasExchange.PositionOverTime#getTimestamp <em>Timestamp</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FasExchangePackage.POSITION_OVER_TIME__POSITION:
				if (resolve) return getPosition();
				return basicGetPosition();
			case FasExchangePackage.POSITION_OVER_TIME__TIMESTAMP:
				return getTimestamp();
		}
