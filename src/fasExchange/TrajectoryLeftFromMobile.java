 ...
 * </p>
 * <ul>
 *   <li>{@link fasExchange.TrajectoryLeftFromMobile#getTrajectory <em>Trajectory</em>}</li>
 *   <li>{@link fasExchange.TrajectoryLeftFromMobile#getTimeStamp <em>Time Stamp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrajectoryLeftFromMobile extends MinimalEObjectImpl.Container {
	 ...
	 * @generated
	 */
	public TrajectoryLeftFromMobile() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FasExchangePackage.Literals.TRAJECTORY_LEFT_FROM_MOBILE;
	}
	...
	/**
	 * Sets the value of the '{@link fasExchange.TrajectoryLeftFromMobile#getTrajectory <em>Trajectory</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link fasExchange.TrajectoryLeftFromMobile#getTimeStamp <em>Time Stamp</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FasExchangePackage.TRAJECTORY_LEFT_FROM_MOBILE__TRAJECTORY:
				if (resolve) return getTrajectory();
				return basicGetTrajectory();
			case FasExchangePackage.TRAJECTORY_LEFT_FROM_MOBILE__TIME_STAMP:
				return getTimeStamp();
		}
